...
class TarefasControllerTest < ActionController::TestCase
  ...
  test "should create tarefa" do
    assert_difference('Tarefa.count') do
      post :create, tarefa: { descricao: @tarefa.descricao, titulo: @tarefa.titulo, usuario_id: @tarefa.usuario_id }
    end
  ...
  test "should update tarefa" do
    patch :update, id: @tarefa, tarefa: { descricao: @tarefa.descricao, titulo: @tarefa.titulo, usuario_id: @tarefa.usuario_id }
    assert_redirected_to tarefa_path(assigns(:tarefa))
  end
